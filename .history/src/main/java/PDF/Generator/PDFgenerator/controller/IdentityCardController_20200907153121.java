...
public class IdentityCardController {
	...
	public String saveEmployee(@Valid @ModelAttribute("identity_card")  Identity_card identity_card, Errors errors, Model model) {
		if(errors.hasErrors()){
			model.addAttribute("first_name", "Plase add first name");
			return "addNew";
		}
